...
parser.add_argument('--trained_model', default='text_detection/craft_mlt_25k.pth', type=str, help='pretrained model')
...
parser.add_argument('--test_folder', default='./text_detection/test', type=str, help='folder path to input images')
